// Author:- Jatin Kumar
// Fractional KnapSack problem: given objects with their profit and weights
// task is to find the maximum profit
// greedy approach is used
// if object can't be put completely then add fraction of it
